...
class Exame(models.Model):
    ...
    laboratorio = models.ForeignKey(Laboratorio, on_delete=models.PROTECT, verbose_name='Laboratorio / Clinica')
...
class Atendimento(models.Model):
    ...
    exames = models.ManyToManyField(Exame, verbose_name='Exame')
